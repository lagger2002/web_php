...
if(isset($_POST["delete"])){
    $id_cate = mysqli_real_escape_string($connect, $_POST['id_cate']);

    $del_query = "DELETE FROM category WHERE id_cate = '$id_cate'";
    $del_query_run = mysqli_query($connect, $del_query);

    if($del_query_run)
    {
        $_SESSION['message'] = "success";
        header("location:../folder_admin/view_category.php");
        exit;
    }
    else{
        $_SESSION['message'] = "Fail";
